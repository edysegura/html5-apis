...
Server-Sent Events (SSE) is a standard describing how servers can initiate data transmission towards browser clients once an initial client connection has been established. It is commonly used to send real-time updates to the client from the server.
